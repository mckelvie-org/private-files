...
- `publish.yml`'s post-release sync now seeds the fresh `## 3.2.6 (2026-07-21)` heading it leaves on
...
- `publish.yml`'s post-release sync now also leaves a fresh, empty `## 3.2.6 (2026-07-21)` heading on
...
- `pypi-template`'s `CHANGELOG.md` stub now comes prepopulated with `## 3.2.6 (2026-07-21)` (and
